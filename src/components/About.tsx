      ...
      <div className="container flex flex-col mx-auto md:py-16 lg:px-8 xl:flex-row xl:px-0 xl:py-24">
        <div className="z-10 order-1 mx-4 mb-24 md:mx-8 md:shadow-lg md:mb-0 md:px-0 lg:mx-0 lg:px-0 xl:w-1/2">
          <div className="w-full h-64 lg:h-72 xl:h-full">
            <iframe
              title="google-map"
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3353.7777777777777!2d-97.17!3d32.74!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x0%3A0x0!2zMzLCsDQ0JzI2LjQiTiA5N8KwMTAnMTIuMCJX!5e0!3m2!1sen!2sus!4v1638000000000!5m2!1sen!2sus&q=4800+US+Hwy+287+Arlington+TX+76017"
              width="100%"
              height="100%"
              style={{ border: 0 }}
            />
